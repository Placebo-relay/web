    ...
    */
    ...
    function loadInitialFile() {
      puzzle.srcImage.src = "https://avatars.githubusercontent.com/u/129430221?v=4";
    }
    //-----------------------------------------------------------------------------
    ...
    let menu = (function () {
      ...
      for (let k = 4; k < menu.items.length; ++k) {
        menu.items[k].element.addEventListener("click", () => events.push({ event: "nbpieces", nbpieces: [6, 12, 25, 50, 100, 200][k - 4] }));
      }
      return menu;
    })();
